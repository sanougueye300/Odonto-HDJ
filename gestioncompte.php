...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Gestion Compte</h1>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="card border-0 shadow">
                            ...
                            <div class="card-body text-center">
                                <h5 class="card-title"><i class="fa-solid fa-user-clock"></i> Nouveau Compte</h5>
                                <p class="card-text">Suivi du temps de travail de vos employés avec précision.</p>
                                <a href="ajoutcompte.php" class="btn btn-outline-primary rounded-pill"><i class="fa-solid fa-user-clock"></i> Entrer</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="card border-0 shadow">
                            ...
                            <div class="card-body text-center">
                                <h5 class="card-title"><i class="fa-solid fa-money-check"></i>Liste Des Utilisateurs</h5>
                                <p class="card-text">Gestion financière et comptabilité de votre cabinet.</p>
                                <a href="listecompte1.php" class="btn btn-outline-primary rounded-pill"><i class="fa-solid fa-money-check"></i> Entrer</a>
                            </div>
                        </div>
                    </div>
