                        ...
                        <div class="navbar-nav mx-auto">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    <a href="cart.php" class="dropdown-item active">Performance</a>
...
<?php
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Performance</h1>
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="index.php">Acceuil</a></li>
                <li class="breadcrumb-item"><a href="#">Pages</a></li>
                <li class="breadcrumb-item active text-white">Performance</li>
            </ol>
        </div>
...
<div class="container-fluid py-5 bg-light">
    <div class="row">
        <div class="col-lg-4 mb-4">
            <div class="p-4 bg-white rounded shadow-sm">
                <h2 class="h5 text-center mb-3">Dentistes</h2>
                <p>Contenu de la première partie de la page.</p>
    ...
    <script>
        ...
        const performanceChart = new Chart(ctx, {
            type: 'doughnut',
            data: {
                labels: ['Nettoyage', 'Blanchiment', 'Orthodontie', 'Implants', 'Extraction', 'Prothèses'],
                datasets: [{
        ...
        <div class="col-lg-4 mb-4">
            <div class="p-4 bg-white rounded shadow-sm">
                <h2 class="h5 text-center mb-3">Section 2</h2>
                <p>Contenu de la deuxième partie de la page.</p>
                 <div class="chart-container">
    ...
    <script>
            ...
            options: {
                plugins: {
                    legend: {
                        ...
                        labels: {
                            color: '#333',
                            usePointStyle: true, // Utiliser des formes de point pour la légende
                            boxWidth: 12, // Largeur des boîtes de légende
                            padding: 15,
                            font: {
                                family: 'Heebo',
                                size: 14
        ...
        <div class="col-lg-4 mb-4">
            <div class="p-4 bg-white rounded shadow-sm">
                <h2 class="h5 text-center mb-3">Section 3</h2>
                <p>Contenu de la troisième partie de la page.</p>
                  <div class="chart-container">
    ...
    <script>
        ...
        const performanceChart1 = new Chart(ctx1, {
            type: 'pie',
            data: {
                labels: ['Nettoyage', 'Blanchiment', 'Orthodontie', 'Implants', 'Extraction', 'Prothèses'],
                datasets: [{
                    ...
                    data: [120, 150, 180, 100, 90, 110],
                    backgroundColor: [
                        'rgba(153, 0, 0, 0.8)',   // Dark Red
                        'rgba(0, 0, 153, 0.8)',   // Dark Blue
                        'rgba(153, 153, 0, 0.8)', // Dark Yellow
                        'rgba(0, 102, 102, 0.8)', // Dark Teal
                        'rgba(76, 0, 153, 0.8)',  // Dark Purple
                        'rgba(153, 76, 0, 0.8)'   // Dark Orange
                    ],
                    borderColor: [
                        'rgba(153, 0, 0, 1)',
                        'rgba(0, 0, 153, 1)',
