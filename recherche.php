...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6"><MARQUEE>Recherchez via l'Identifiant</MARQUEE></h1>
...
// Fonction pour récupérer un patient par identifiant
function getPatientByIdentifiant($identifiant) {
    global $db;
    $stmt = $db->prepare("SELECT * FROM patients WHERE identifiant = ?");
    $stmt->bind_param("s", $identifiant);
    $stmt->execute();
...
if (isset($_POST['search_identifiant'])) {
    $search_identifiant = $_POST['search_identifiant'];
    $patients = [getPatientByIdentifiant($search_identifiant)];
}
?>
        ...
        <div class="col-lg-6">
            <form method="post" action="" class="mb-3">
                <div class="input-group">
                    <input name="search_identifiant" class="form-control rounded-pill border-primary" type="text" placeholder="Rechercher par identifiant" value="<?php echo htmlspecialchars($search_identifiant); ?>">
            ...
            <?php foreach ($patients as $patient): ?>
                <div class="col-lg-4 mb-4">
                    <div class="card shadow border-0 rounded-lg">
                        <div class="card-body">
                            <h5 class="card-title text-primary"><?php echo $patient['prenom'] . ' ' . $patient['nom']; ?></h5>
                            <p class="card-text"><strong>Identifiant:</strong> <?php echo $patient['identifiant']; ?></p>
                            <p class="card-text"><strong>Téléphone:</strong> <?php echo $patient['telephone']; ?></p>
                            <div class="mt-3 text-center">
                                <a href="modifier_patient.php?id=<?php echo $patient['identifiant']; ?>" class="btn btn-outline-primary btn-sm"><i class="fas fa-edit"></i></a>
                                <button class="btn btn-outline-info btn-sm"><i class="fas fa-info-circle"></i></button>
