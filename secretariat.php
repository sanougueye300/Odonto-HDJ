        ...
        <div class="container-fluid fixed-top">
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    <a href="secretariat.php" class="navbar-brand"><h1 class="text-primary display-6"><i class="fa-solid fa-tooth"></i>AdminOdonto</h1></a>
                    <button class="navbar-toggler py-2 px-3" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse">
                        <span class="fa fa-bars text-primary"></span>
                    </button>
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            <a href="secretariat.php" class="nav-item nav-link active"><i class="fa-solid fa-house-chimney-medical"></i> Le cabinet</a>
    ...
    <div class="container py-5">
        ...
        <div class="d-flex justify-content-center mb-5">
            <ul class="nav nav-pills">
                <li class="nav-item">
                    <a class="nav-link active rounded-pill mx-2 px-4 py-2" data-bs-toggle="pill" href="#tab-1"><i class="fa-solid fa-pen-clip fa-spin"></i> secrétariat</a>
                </li>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="card border-0 shadow">
                            <img src="img/heure.jpg" class="card-img-top rounded-top" alt="Service Pointage">
                            <div class="card-body text-center">
                                <h5 class="card-title"><i class="fa-solid fa-user-clock"></i> Nouveau Patient</h5>
                                <p class="card-text">Suivi du temps de travail de vos employés avec précision.</p>
                                <a href="ajoutpatient.php" class="btn btn-outline-primary rounded-pill"><i class="fa-solid fa-user-clock fa-spin"></i> Entrer</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="card border-0 shadow">
                            <img src="img/heure.jpg" class="card-img-top rounded-top" alt="Service Pointage">
                            <div class="card-body text-center">
                                <h5 class="card-title"><i class="fa-solid fa-user-clock"></i> Recherche</h5>
                                <p class="card-text">Suivi du temps de travail de vos employés avec précision.</p>
                                <a href="recherche.php" class="btn btn-outline-primary rounded-pill"><i class="fa-solid fa-user-clock fa-spin"></i> Entrer</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="card border-0 shadow">
                            <img src="img/comptabilite.jpg" class="card-img-top rounded-top" alt="Service Comptabilité">
                            <div class="card-body text-center">
                                <h5 class="card-title"><i class="fa-solid fa-money-check"></i> Liste Patient</h5>
                                <p class="card-text">Gestion financière et comptabilité de votre cabinet.</p>
                                <a href="listepatient.php" class="btn btn-outline-primary rounded-pill"><i class="fa-solid fa-money-check fa-spin"></i> Entrer</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="card border-0 shadow">
                            <img src="img/rendez-vous.png" class="card-img-top rounded-top" alt="Service Comptabilité">
                            <div class="card-body text-center">
                                <h5 class="card-title"><i class="fa-solid fa-heart-pulse"></i> Rendez Vous du jour</h5>
                                <p class="card-text">Gestion financière et comptabilité de votre cabinet.</p>
                                <a href="rendezvous.php" class="btn btn-outline-primary rounded-pill"><i class="fa-solid fa-heart-pulse fa-spin"></i>  Entrer</a>
                            </div>
                        </div>
                    </div>
