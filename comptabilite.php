...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="navbar-nav mx-auto">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    <a href="cart.php" class="dropdown-item active">Comptabilite</a>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Comptabilite</h1>
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="index.php">Acceuil</a></li>
                <li class="breadcrumb-item"><a href="#">Pages</a></li>
                <li class="breadcrumb-item active text-white">Comptabilite</li>
            </ol>
        </div>
...
<div class="container-fluid features py-5">
    <div class="container">
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
            <!-- Feature Item 1 -->
             <div class="col">
                <div class="feature-item text-center rounded p-4 border bg-light shadow-sm">
                    <div class="feature-icon rounded-circle bg-warning mb-3 p-3 d-inline-flex align-items-center justify-content-center">
                        <i class="fas fa-file-invoice-dollar fa-3x text-white"></i>
                    </div>
                    <h5 class="mb-3">Facturation simplifiée</h5>
                    <p class="mb-4">Facilitez le processus de facturation pour vous et vos patients.</p>
                    <button type="button" class="btn btn-outline-warning rounded-pill px-4 py-2"><a href="facture.php">En savoir plus</a></button>
                </div>
            </div>
            <!-- Feature Item 2 -->
            <div class="col">
                <div class="feature-item text-center rounded p-4 border bg-light shadow-sm">
                    ...
                    <h5 class="mb-3">Liste Des Factures</h5>
                    <p class="mb-4">Facilitez le processus de facturation pour vous et vos patients.</p>
                    <button type="button" class="btn btn-outline-warning rounded-pill px-4 py-2"><a href="listefacture.php">En savoir plus</a></button>
                </div>
            </div>
            <!-- Feature Item 3 -->
            <div class="col">
                <div class="feature-item text-center rounded p-4 border bg-light shadow-sm">
                    <div class="feature-icon rounded-circle bg-warning mb-3 p-3 d-inline-flex align-items-center justify-content-center">
                        <i class="fa-brands fa-cc-visa fa-3x text-white"></i>
                    </div>
                    <h5 class="mb-3">Paiement Par Carte</h5>
                    <p class="mb-4">Acceptez les paiements par carte de manière sécurisée et fiable.</p>
                    <button type="button" class="btn btn-outline-warning rounded-pill px-4 py-2">En savoir plus</button>
                </div>
            </div>
            <!-- Feature Item 4 -->
            <div class="col">
                <div class="feature-item text-center rounded p-4 border bg-light shadow-sm">
                    ...
                    <h5 class="mb-3">Assurance</h5>
                    <p class="mb-4">Fournissez un support personnalisé et réactif à vos patients.</p>
                    <button type="button" class="btn btn-outline-warning rounded-pill px-4 py-2">En savoir plus</button>
                </div>
            </div>
            <!-- Feature Item 5 -->
            <div class="col">
                <div class="feature-item text-center rounded p-4 border bg-light shadow-sm">
                    <div class="feature-icon rounded-circle bg-warning mb-3 p-3 d-inline-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-truck-medical fa-3x text-white"></i>
                    </div>
                    <h5 class="mb-3">Gestion Fournisseurs</h5>
                    <p class="mb-4">Fournissez un support personnalisé et réactif à vos patients.</p>
                    <button type="button" class="btn btn-outline-warning rounded-pill px-4 py-2">En savoir plus</button>
                </div>
            </div>
            ...
            <div class="col">
                <div class="feature-item text-center rounded p-4 border bg-light shadow-sm">
                    <div class="feature-icon rounded-circle bg-warning mb-3 p-3 d-inline-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-file-invoice fa-3x text-white"></i>
                    </div>
                    <h5 class="mb-3">Rapport Financier</h5>
                    <p class="mb-4">Fournissez un support personnalisé et réactif à vos patients.</p>
                    <button type="button" class="btn btn-outline-warning rounded-pill px-4 py-2">En savoir plus</button>
                </div>
            </div>
            ...
            <div class="col">
                <div class="feature-item text-center rounded p-4 border bg-light shadow-sm">
                    <div class="feature-icon rounded-circle bg-warning mb-3 p-3 d-inline-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-piggy-bank fa-3x text-white"></i>
                    </div>
                    <h5 class="mb-3">Gestion des impôts</h5>
                    <p class="mb-4">Fournissez un support personnalisé et réactif à vos patients.</p>
                    <button type="button" class="btn btn-outline-warning rounded-pill px-4 py-2">En savoir plus</button>
                </div>
            </div>
            ...
            <div class="col">
                <div class="feature-item text-center rounded p-4 border bg-light shadow-sm">
                    ...
                    <h5 class="mb-3">Gestion des budgets</h5>
                    <p class="mb-4">Fournissez un support personnalisé et réactif à vos patients.</p>
                    <button type="button" class="btn btn-outline-warning rounded-pill px-4 py-2">En savoir plus</button>
                </div>
            </div>
