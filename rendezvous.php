...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Liste des Rendez-Vous</h1>
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="index.php">Acceuil</a></li>
                <li class="breadcrumb-item"><a href="secretariat.php">Secretariat</a></li>
                <li class="breadcrumb-item active text-white">Rendez-Vous</li>
            </ol>
        </div>
        ...
        <table class="table table-custom">
            ...
            <tbody class="table-group-divider">
                <tr>
                    ...
                    <td>Gueye</td>
                    <td>775994942</td>
                    <td><button class='btn btn-sm rounded-lg bg-primary border mt-1'>
                        <i class="fa-solid fa-gears fa-spin text-white"></i>
                    </button>
                    <button class='btn btn-sm rounded-lg bg-warning border mt-1'>
                        <i class="fa-regular fa-eye text-white"></i>
                    </button>
                    <button class='btn btn-sm rounded-lg bg-danger border mt-1'>
                ...
                <tr>
                    ...
                    <td>775139577</td>
                    <td>
                       <button class='btn btn-sm rounded-lg bg-primary border mt-1'>
                        <i class="fa-solid fa-gears fa-spin text-white"></i>
                    </button>
                    <button class='btn btn-sm rounded-lg bg-warning border mt-1'>
                        <i class="fa-regular fa-eye text-white"></i>
