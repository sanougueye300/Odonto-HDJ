...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="navbar-nav mx-auto">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    <a href="cart.php" class="dropdown-item active">Reseaux</a>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Reseaux</h1>
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="index.php">Acceuil</a></li>
                <li class="breadcrumb-item"><a href="#">Pages</a></li>
                <li class="breadcrumb-item active text-white">Reseaux</li>
            </ol>
        </div>
...
.main_back {
    ...
    width: 11em;
    height: 11em;
    background: linear-gradient(270deg, #f40303, #00ffff, #ffd900);
    z-index: -2;
