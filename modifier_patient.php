...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6"><MARQUEE>Ajouter un Patient</MARQUEE></h1>
...
$dbname = "dallaldiam"; // Mettez le nom de votre base de données
...
// Variable pour stocker les informations du patient
$patient = array();

// Vérification que l'identifiant du patient est défini et est un entier valide
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    // Récupération de l'identifiant du patient depuis la requête GET sécurisée
    $patient_id = $_GET['id'];

    // Requête SQL pour sélectionner les informations du patient par identifiant
    $sql = "SELECT * FROM patients WHERE identifiant = ?";
    ...
    if ($result->num_rows > 0) {
        // Récupération des données du patient dans un tableau associatif
    ...
    echo "Identifiant de patient non valide.";
}
    ...
    <div class="container py-5 d-flex justify-content-center align-items-center" style="min-height: 100vh;">
        <div class="col-md-12 col-lg-8">
            <div class="card card-custom">
                ...
                <form action="#" method="POST"> <!-- Assurez-vous de spécifier la méthode POST pour la mise à jour -->
                    <div class="row g-4">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-custom" name="service">
                                    <option value="Orthodontie" <?php if ($patient['service'] == 'Orthodontie') echo 'selected'; ?>>Orthodontie</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-custom" name="prenom" placeholder="Entrez le prénom" value="<?php echo $patient['prenom']; ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label form-label-custom"><strong>Nom<sup class="required">*</sup></strong></label>
                                <input type="text" class="form-control form-control-custom" name="nom" placeholder="Entrez le nom" value="<?php echo $patient['nom']; ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="form-check me-5">
                                        <input class="form-check-input" type="radio" id="homme" name="sexe" value="homme" <?php if ($patient['sexe'] == 'homme') echo 'checked'; ?>>
                                        <label class="form-check-label" for="homme">Homme</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="femme" name="sexe" value="femme" <?php if ($patient['sexe'] == 'femme') echo 'checked'; ?>>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control form-control-custom" name="age" placeholder="Entrez l'âge" value="<?php echo $patient['age']; ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="form-label form-label-custom"><strong>Téléphone<sup class="required">*</sup></strong></label>
                                <input type="tel" class="form-control form-control-custom" name="telephone" placeholder="Numéro de téléphone" value="<?php echo $patient['telephone']; ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label form-label-custom"><strong>Adresse<sup class="required">*</sup></strong></label>
                                <input type="text" class="form-control form-control-custom" name="adresse" placeholder="Entrez l'adresse" value="<?php echo $patient['adresse']; ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label form-label-custom"><strong>Identifiant<sup class="required">*</sup></strong></label>
                                <input type="text" class="form-control form-control-custom" name="identifiant" placeholder="Entrez l'identifiant" value="<?php echo $patient['identifiant']; ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label form-label-custom"><strong>Profession<sup class="required">*</sup></strong></label>
                                <input type="text" class="form-control form-control-custom" name="profession" placeholder="Entrez la profession" value="<?php echo $patient['profession']; ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label form-label-custom"><strong>Dentiste traitant<sup class="required">*</sup></strong></label>
                             <select class="form-control form-control-custom" name="dentiste_traitant">
    <option value="Dr. John Doe" <?php if ($patient['dentiste_traitant'] == 'Dr. John Doe') echo 'selected'; ?>>Dr. John Doe</option>
    <option value="Dr. Jane Smith" <?php if ($patient['dentiste_traitant'] == 'Dr. Jane Smith') echo 'selected'; ?>>Dr. Jane Smith</option>
    <option value="Dr. Albert Brown" <?php if ($patient['dentiste_traitant'] == 'Dr. Albert Brown') echo 'selected'; ?>>Dr. Albert Brown</option>
    <option value="Dr. Emily White" <?php if ($patient['dentiste_traitant'] == 'Dr. Emily White') echo 'selected'; ?>>Dr. Emily White</option>
</select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-custom" name="mode_paiement">
                                    ...
                                    <option value="Carte de crédit" <?php if ($patient['mode_paiement'] == 'Carte de crédit') echo 'selected'; ?>>Carte de crédit</option>
                                    <option value="Espèces" <?php if ($patient['mode_paiement'] == 'Espèces') echo 'selected'; ?>>Espèces</option>
                                    <option value="Chèque" <?php if ($patient['mode_paiement'] == 'Chèque') echo 'selected'; ?>>Chèque</option>
                                    <option value="Virement bancaire" <?php if ($patient['mode_paiement'] == 'Virement bancaire') echo 'selected'; ?>>Virement bancaire</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-custom" name="diagnostic" placeholder="Entrez le diagnostic" value="<?php echo $patient['diagnostic']; ?>">
                            </div>
                        </div>
                            <div class="col-md-12">
