                        ...
                        <div class="navbar-nav mx-auto">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    <a href="cart.php" class="dropdown-item active">Messagerie</a>
...
<?php
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Messagerie</h1>
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="index.php">Acceuil</a></li>
                <li class="breadcrumb-item"><a href="#">Pages</a></li>
                <li class="breadcrumb-item active text-white">Messagerie</li>
            </ol>
        </div>
...
try {
    // Database connection
    $connexion = new PDO("mysql:host=localhost;dbname=rendez-vous", "root", "");
    $connexion->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

    // Fetch data from the database
    $stmt = $connexion->query("SELECT * FROM infopatients");
    ...
    foreach ($rows as $index => $row) {
        ...
        echo "<td>";
        echo "<button class='btn btn-md rounded-circle bg-light border mt-1'>";
