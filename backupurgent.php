                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-custom" name="diagnostic" placeholder="Entrez le diagnostic" required>
                            </div>
                        </div>
                            ...
                            <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-md-5 offset-md-1">
                                        <div class="form-group">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="treatment1" name="plan_traitement[]" value="CONSULTATION">
                                                <label class="form-check-label" for="treatment1">CONSULTATION</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="treatment2" name="plan_traitement[]" value="CONSULTATION URGENTE">
                                    ...
                                    <div class="col-md-5 offset-md-1">
                                        <div class="form-group">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="treatment11" name="plan_traitement[]" value="RADIOGRAPHIE PANORAMIQUE">
                                                <label class="form-check-label" for="treatment11">RADIOGRAPHIE PANORAMIQUE</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="treatment12" name="plan_traitement[]" value="TELERADIOGRAPHIE">
                                                <label class="form-check-label" for="treatment12">TELERADIOGRAPHIE</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="container">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-label form-label-custom"><strong>Documents</strong></label>
                                    <div class="input-group">
                                        <input type="file" name="documents[]" multiple class="form-control form-control-custom" id="documents">
