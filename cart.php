                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">
                                    <div class="d-flex align-items-center">
                                        <img src="img/junior.jpg" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;" alt="">
                                    </div>
                                </th>
                                <td>
                                    <p class="mb-0 mt-4">Djibril Sanou Gueye</p>
                                </td>
                                <td>
                                    <p class="mb-0 mt-4">Dentiste</p>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="mb-0 mt-4">Dicko Diallo</p>
                                </td>
                                <td>
                                    <p class="mb-0 mt-4">Dentiste</p>
                                </td>
