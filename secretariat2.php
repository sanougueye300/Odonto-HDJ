...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Secretariat</h1>
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="index.php">Acceuil</a></li>
                <li class="breadcrumb-item"><a href="#">Pages</a></li>
                <li class="breadcrumb-item active text-white">Secretariat</li>
            </ol>
        </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="card border-0 shadow">
                            ...
                            <div class="card-body text-center">
                                <h5 class="card-title"><i class="fa-solid fa-heart-pulse"></i> Rendez Vous </h5>
                                <p class="card-text">Gestion financière et comptabilité de votre cabinet.</p>
                                <a href="rendezvous.php" class="btn btn-outline-primary rounded-pill"><i class="fa-solid fa-heart-pulse"></i>  Entrer</a>
                            </div>
                        </div>
                    </div>
