    ...
    <div class="container py-5">
        ...
        <div class="d-flex justify-content-center mb-5">
            <ul class="nav nav-pills">
                <li class="nav-item">
                    <a class="nav-link active rounded-pill mx-2 px-4 py-2" data-bs-toggle="pill" href="#tab-1">Dentiste</a>
                </li>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="card border-0 shadow">
                            ...
                            <div class="card-body text-center">
                                <h5 class="card-title"><i class="fa-solid fa-user-clock"></i> Recherche par Reference</h5>
                                <p class="card-text">Suivi du temps de travail de vos employés avec précision.</p>
                                <a href="recherche.php" class="btn btn-outline-primary rounded-pill"><i class="fa-solid fa-user-clock"></i> Entrer</a>
                            </div>
                        </div>
                    </div>
                       ...
                       <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="card border-0 shadow">
                            <img src="img/heure.jpg" class="card-img-top rounded-top" alt="Service Pointage">
                            <div class="card-body text-center">
                                <h5 class="card-title"><i class="fa-solid fa-user-clock"></i> Liste Affectation</h5>
                                <p class="card-text">Suivi du temps de travail de vos employés avec précision.</p>
                                <a href="listepatient1.php" class="btn btn-outline-primary rounded-pill"><i class="fa-solid fa-user-clock"></i> Entrer</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="card border-0 shadow">
                            ...
                            <div class="card-body text-center">
                                <h5 class="card-title"><i class="fa-solid fa-heart-pulse"></i> Miseajour</h5>
                                <p class="card-text">Gestion financière et comptabilité de votre cabinet.</p>
                                <a href="miseajour.php" class="btn btn-outline-primary rounded-pill"><i class="fa-solid fa-heart-pulse"></i>  Entrer</a>
                            </div>
                        </div>
                    </div>
