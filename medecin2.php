...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Gestion Patients</h1>
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="index.php">Acceuil</a></li>
                <li class="breadcrumb-item"><a href="#">Pages</a></li>
                <li class="breadcrumb-item active text-white">Medecin</li>
            </ol>
        </div>
...
<div class="tab-content">
            ...
            <div id="tab-1" class="tab-pane fade show active">
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="card border-0 shadow">
                            ...
                            <div class="card-body text-center">
                                ...
                                <a href="ajoutpatient.php" class="btn btn-outline-primary rounded-pill"><i class="fa-solid fa-user-clock"></i> Entrer</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="card border-0 shadow">
                            ...
                            <div class="card-body text-center">
                                ...
                                <a href="listepatient.php" class="btn btn-outline-primary rounded-pill"><i class="fa-solid fa-money-check"></i> Entrer</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="card border-0 shadow">
                            <img src="img/c8.jpg" class="card-img-top rounded-top" alt="Service Comptabilité">
                            <div class="card-body text-center">
                                <h5 class="card-title"><i class="fa-solid fa-heart-pulse"></i> Sous Traitement</h5>
                                <p class="card-text">Gestion financière et comptabilité de votre cabinet.</p>
                                <a href="soustraitement.php" class="btn btn-outline-primary rounded-pill"><i class="fa-solid fa-heart-pulse"></i>  Entrer</a>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="card border-0 shadow">
                            ...
                            <div class="card-body text-center">
                                <h5 class="card-title"><i class="fa-solid fa-money-check"></i> Fidelisations</h5>
                                <p class="card-text">Gestion financière et comptabilité de votre cabinet.</p>
                                <a href="fidelisation.php" class="btn btn-outline-primary rounded-pill"><i class="fa-solid fa-money-check"></i> Entrer</a>
                            </div>
                        </div>
                    </div>
